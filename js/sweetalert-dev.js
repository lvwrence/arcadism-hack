...
bottom_of_window,
players,
mqFade = window.matchMedia( "(min-width: 768px)" );
...
function fade_scroll(){
    ...
    if (mqFade.matches) {
        players = $("#leaderboard li");
        players.each(function(i){
            bottom_of_object = $(this).offset().top + $(this).outerHeight() + 42;
        ...
        players_title = $(".top_players_title");
        players_title.each(function(i){
            bottom_of_object = $(this).offset().top + $(this).outerHeight() + 42;
            bottom_of_window = $(window).scrollTop() + $(window).height();
            if (bottom_of_window <= (bottom_of_object)){
                $(this).addClass('blur');
        ...
        players = $("#leaderboard li");
        players.each(function(i){
            bottom_of_object = $(this).offset().top + $(this).outerHeight() - 30;
            bottom_of_window = $(window).scrollTop() + $(window).height();
            if (bottom_of_window <= (bottom_of_object)){
                $(this).addClass('blur');
            } else if (bottom_of_window > (bottom_of_object)){
